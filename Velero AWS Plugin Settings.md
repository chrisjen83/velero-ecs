# Velero AWS Plugin Settings

Here are all of the optional and mandatory options to add to your Velero install command in the **--backup-location-config** section of the install command.

Important settings for ECS are:
